...
package com.tp.birt.report.engine.emitter.config.docx.i18n;
...
public class Messages {
	...
	private static final String BUNDLE_NAME = "com.tp.birt.report.engine.emitter.config.docx.i18n.messages"; //$NON-NLS-1$
