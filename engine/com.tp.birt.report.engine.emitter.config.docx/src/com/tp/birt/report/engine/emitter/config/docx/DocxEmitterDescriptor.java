...
package com.tp.birt.report.engine.emitter.config.docx;
...
import com.tp.birt.report.engine.emitter.config.docx.i18n.Messages;
...
public class DocxEmitterDescriptor extends AbstractEmitterDescriptor {
	...
	protected void initOptions() {
		loadDefaultValues("com.tp.birt.report.engine.emitter.config.docx");
